                            ...
                            <form action="">
                                            ...
                                            <tbody>
                                                @foreach ($list as $data)
                                                    <tr id="cart_box{{ $data->attr_id }}">
                                                        ...
                                                        <td id="total_price_{{ $data->attr_id }}">Rs
                                                            {{ $data->price * $data->qty }}</td>
                                                    </tr>
                                                @endforeach
                                                <tr>
                                ...
                                @else
                                    <div class="text-center">
                                        <h2 class="text-center mt-4">No items in Cart</h2>
                                        <button class="text-center mt-4 btn btn-primary">Continue Shopping</button>
                                    </div>
                                @endif
                            </form>
                            <!-- Cart Total view -->

                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="p_name" class="control-label mb-1"> Name <sup
                                            class="text-danger">*</sup></label>
                                    <input id="p_name" value="{{ $name }}" name="name" type="text"
                                ...
                                <div class="form-group">
                                    <label for="p_slug" class="control-label mb-1"> Slug <sup
                                            class="text-danger">*</sup></label>
                                    <input id="p_slug" value="{{ $slug }}" name="slug" type="text"
                                        class="form-control" aria-required="true" aria-invalid="false" readonly>
                                    @error('slug')
                                        <div class="alert alert-danger" role="alert">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    <label for="sku" class=""> SKU <sup class="text-danger">*</sup></label>
                                    <input id="sku" name="sku" type="number" class="form-control"
                                        {{-- value="{{ $pAArr['sku'] }}" --}} value="{{ $sku }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="mrp" class="control-label mb-1"> Cutoff Price <sup
                                            class="text-danger">*</sup></label>
                                ...
                                <div class="form-group">
                                    <label for="image" class="control-label mb-1">Thumbnail Image<sup
                                            class="text-danger">*</sup></label>
                                    ...
                                    @if ($image != '')
                                        <a href="{{ asset('storage/media/product/' . $image) }}" target="_blank"><img
                                                width="100px" src="{{ asset('storage/media/product/' . $image) }}" /></a>
                                    @endif
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="category_id" class="control-label mb-1"> Category<sup
                                                    class="text-danger">*</sup></label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="category_id" class="control-label mb-1"> Brand<sup
                                                    class="text-danger">*</sup></label>
                                        ...
                                        {{-- <div class="col-md-4">
                                            <label for="model" class="control-label mb-1"> Model (optional)</label>
                                ...
                                {{-- <div class="form-group">
                                    <label for="short_desc" class="control-label mb-1"> Short Desc<sup
                                        class="text-danger">*</sup></label>
                                    ...
                                    <div class="row" id="product_images_box">
                                        ...
                                        @foreach ($productImagesArr as $key => $val)
                                            ...
                                            <div class="col-md-4 product_images_{{ $loop_count_num++ }}">
                                                ...
                                                @if ($pIArr['images'] != '')
                                                    <a href="{{ asset('storage/media/product' . $pIArr['images']) }}"
                                                        target="_blank"><img width="100px"
                                                            src="{{ asset('storage/media/product' . $pIArr['images']) }}" /></a>
                                                @endif
                                            </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <label for="size_id" class="control-label mb-1"> Size<sup
                                                        class="text-danger">*</sup></label>
                                            ...
                                            <div class="col-md-3">
                                                <label for="color_id" class="control-label mb-1"> Color<sup
                                                        class="text-danger">*</sup></label>
                                            ...
                                            <div class="col-md-2">
                                                <label for="qty" class="control-label mb-1"> Qty<sup
                                                        class="text-danger">*</sup></label>
                                            ...
                                            <div class="col-md-4">
                                                <label for="attr_image" class="control-label mb-1"> Image<sup
                                                        class="text-danger">*</sup></label>

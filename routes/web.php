...
Route::post('registration', [UserController::class, 'registration_process'])->name('user.register');
Route::post('login', [UserController::class, 'login_process'])->name('user.auth');
...
Route::post('remove_coupon_code', [FrontendController::class, 'remove_coupon_code']);

Route::post('place_order', [FrontendController::class, 'place_order']);
Route::get('/payment_methods/{val}/{tokn}', [FrontendController::class, 'payment_methods']);
Route::get('/order_placed/{val}/{order_id}', [FrontendController::class, 'order_placed']);
Route::get('/confirm_cod/{order_id}', [FrontendController::class, 'cash_on_delivery']);

Route::get('/order_fail', [FrontendController::class, 'order_fail']);
Route::post('/khalti/payment/verify', [FrontendController::class, 'verifyPayment'])->name('khalti.verifyPayment');
...
Route::group(['middleware' => 'admin_auth'], function () {
    ...
    Route::post('admin/settings/save', [SettingController::class, 'store'])->name('settings.save');
